...
public class Database {
    ...
    static City kobryn = new City("Кобрин", 84.96, 175000, false, false);
    //Витебская область
    ...
    static City bychov = new City("Быхов", 20.32, 30000, false, false);
    //Районы
    //Брестская область
    ...
    static District kobrynDistr = new District("Кобринский район", 2171.88, 205000, kobryn);
    //Витебская область
    ...
    static District bychovDistr = new District("Быховский район", 1947.21, 48000, bychov);
    //Области
    static Region brestRegion = new Region("Брестская область", brestDistr, kobrynDistr, pinskDistr);
    ...
    static Region mogilevRegion = new Region("Могилевская область", mogilevDistr, bobruiskDistr, bychovDistr);
